...
import * as demoFixtures from "@/lib/demo/fixtures";
import type {
  FundSummary,
  TransactionWithFund,
  BillWithFund,
...
export const getServerUser = cache(async (): Promise<AuthUser | null> => {
  try {
    if (isDemoMode()) {
      return demoFixtures.demoAuthUser;
    }
...
export const getDashboardData = cache(async (): Promise<DashboardData> => {
  ...
  if (isDemoMode()) {
    return demoFixtures.getDemoDashboardData();
  }
...
export const getTransactionsData = cache(
  async (): Promise<TransactionsData> => {
    ...
    if (isDemoMode()) {
      return demoFixtures.getDemoTransactionsData();
    }
...
export const getLedgerEntriesData = cache(
  async (): Promise<LedgerEntryWithRelations[]> => {
    ...
    if (isDemoMode()) {
      return demoFixtures.getDemoLedgerEntries();
    }
...
export const getMembersData = cache(async (): Promise<Member[]> => {
  ...
  if (isDemoMode()) {
    return demoFixtures.getDemoMembers();
  }
...
export const getBillsData = cache(async (): Promise<BillsData> => {
  ...
  if (isDemoMode()) {
    return demoFixtures.getDemoBillsData();
  }
...
export const getAdvancesData = cache(async (): Promise<AdvancesData> => {
  ...
  if (isDemoMode()) {
    return demoFixtures.getDemoAdvancesData();
  }
...
export const getOfferingsData = cache(async (): Promise<OfferingsData> => {
  ...
  if (isDemoMode()) {
    return demoFixtures.getDemoOfferingsData();
  }
...
export const getCashBreakdownData = cache(
  async (): Promise<CashBreakdownData[]> => {
    ...
    if (isDemoMode()) {
      return demoFixtures.getDemoCashBreakdown();
    }
...
export const getFundsPageData = cache(async (): Promise<FundsPageData> => {
  ...
  if (isDemoMode()) {
    return demoFixtures.getDemoFundsPageData();
  }
...
export const getMemberContributionsData = cache(
  async (): Promise<MemberContribution[]> => {
    ...
    if (isDemoMode()) {
      return demoFixtures.getDemoMemberContributions();
    }
...
export const getNotificationsData = cache(
  async (): Promise<NotificationData[]> => {
    ...
    if (isDemoMode()) {
      return demoFixtures.getDemoNotifications();
    }
...
export const getReportsData = cache(
  async (dateRange: {
    ...
    if (isDemoMode()) {
      return demoFixtures.getDemoReportsData(dateRange);
    }
