    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in animate-slide-in-from-bottom-4 animate-duration-700">
        <Card className="bg-white/10 backdrop-blur-xl border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] shadow-2xl animate-scale-in">
          <CardHeader className="text-center pb-8 animate-fade-in animate-slide-in-from-top-4 animate-duration-700" style={{ animationDelay: '200ms' }}>
            <div className="flex justify-center mb-6">
              <div className="relative animate-fade-in animate-slide-in-from-top-4 animate-duration-700" style={{ animationDelay: '400ms' }}>
            ...
            <CardTitle className="text-4xl font-bold mb-2 text-responsive-2xl bg-gradient-to-r from-white via-white/90 to-white/70 bg-clip-text text-transparent animate-fade-in animate-slide-in-from-top-4 animate-duration-700" style={{ animationDelay: '600ms' }}>
              Church Finance
            </CardTitle>
            <CardDescription className="bg-gradient-to-r from-white via-white/90 to-white/70 bg-clip-text text-transparent text-md animate-fade-in animate-slide-in-from-top-4 animate-duration-700" style={{ animationDelay: '800ms' }}>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-4">
                <div className="space-y-2 animate-fade-in animate-slide-in-from-bottom-4 animate-duration-700" style={{ animationDelay: '1000ms' }}>
                ...
                <div className="space-y-2 animate-fade-in animate-slide-in-from-bottom-4 animate-duration-700" style={{ animationDelay: '1200ms' }}>
            ...
            <div className="text-center animate-fade-in animate-slide-in-from-bottom-4 animate-duration-700" style={{ animationDelay: '1600ms' }}>
            ...
            <div className="mt-8 p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300 animate-fade-in animate-slide-in-from-bottom-4 animate-duration-700" style={{ animationDelay: '1800ms' }}>
              <p className="text-sm font-semibold mb-4 text-center bg-gradient-to-r from-white via-white/90 to-white/70 bg-clip-text text-transparent">Demo Accounts</p>
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                  <div>
                    ...
                    <p className="text-xs text-white/70">Full access to all features</p>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                  <div>
                    ...
                    <p className="text-xs text-white/70">Financial management</p>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-white/80">treasurer@church.com</p>
