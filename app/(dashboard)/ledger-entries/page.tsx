...
export const metadata: Metadata = {
  title: "Ledger Entries | Church Finance",
  description:
    "Manage ledger entries and subgroups for financial categorization.",
};
...
export default async function LedgerEntriesPage(): Promise<JSX.Element> {
  ...
  return (
    <Suspense
      fallback={<FullScreenLoader message="Loading ledger entries..." />}
    >
      <LedgerEntriesClient
