  ...
  const loadEntryData = useCallback(async () => {
    ...
    try {
      ...
      setEntryForm({
        ...
        status: (entry.status as "draft" | "active" | "completed" | "cancelled") || "draft",
        priority: (entry.priority as "low" | "medium" | "high" | "urgent") || "medium",
        approval_status: (entry.approval_status as "pending" | "approved" | "rejected") || "pending",
        ...
        subgroups: hasSubgroups ? entry.ledger_subgroups!.map(subgroup => ({
          ...
          status: (subgroup.status as "draft" | "active" | "completed" | "cancelled") || "draft",
          priority: (subgroup.priority as "low" | "medium" | "high" | "urgent") || "medium",
